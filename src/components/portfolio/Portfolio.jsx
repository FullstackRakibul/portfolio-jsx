    ...
    return(<>
        ...
        <section className="work container section" id="work">
            ...
            <div className="work__filters">
                ...
                <span className="work__item"> UI / UX </span>
                <span className="work__item"> Wordpress </span>
                <span className="work__item"> Laravael </span>
                <span className="work__item"> Django </span>
                <span className="work__item"> Js Framework </span>
            </div>
